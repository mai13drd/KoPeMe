...
public abstract class KoPeMeTestcase extends TestCase {
   ...
   protected boolean useBeforeClassEverytime() {
      return false;
   }
   ...
   public void runBare() throws InterruptedException, IOException {
      ...
      RunConfiguration configuration = new RunConfiguration(getWarmup(), getRepetitions(), showStart(), redirectToTemp(), redirectToNull(), logFullData(), useBeforeClassEverytime());
